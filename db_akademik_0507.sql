...
--
-- Host: 127.0.0.1
-- Generation Time: 21 Jan 2022 pada 16.28
...
--
-- Dumping data untuk tabel `tbl_akademik_0507`
--

INSERT INTO `tbl_akademik_0507` (`Id`, `nim`, `nama`, `jk`, `jurusan`, `alamat`) VALUES
...
--
-- Indexes for table `tbl_akademik_0507`
--
ALTER TABLE `tbl_akademik_0507`
  ADD PRIMARY KEY (`Id`);
COMMIT;
